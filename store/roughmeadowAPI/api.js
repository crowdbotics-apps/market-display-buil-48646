...
const roughmeadowAPI = axios.create({
  baseURL: "https://market-display-buil-48646.botics.co",
  headers: { Accept: "application/json", "Content-Type": "application/json" }
})
function api_docs_schema_retrieve(payload) {
  return roughmeadowAPI.get(`/api-docs/schema/`, {
    params: { lang: payload.lang }
  })
}
function api_v1_login_create(payload) {
  return roughmeadowAPI.post(`/api/v1/login/`, payload)
}
...
function rest_auth_logout_create(payload) {
  return roughmeadowAPI.post(`/rest-auth/logout/`)
}
function rest_auth_password_change_create(payload) {
  return roughmeadowAPI.post(`/rest-auth/password/change/`, payload)
}
function rest_auth_password_reset_create(payload) {
  return roughmeadowAPI.post(`/rest-auth/password/reset/`, payload)
}
function rest_auth_password_reset_confirm_create(payload) {
  return roughmeadowAPI.post(`/rest-auth/password/reset/confirm/`, payload)
}
function rest_auth_registration_create(payload) {
  return roughmeadowAPI.post(`/rest-auth/registration/`, payload)
}
function rest_auth_registration_resend_email_create(payload) {
  return roughmeadowAPI.post(`/rest-auth/registration/resend-email/`, payload)
}
function rest_auth_registration_verify_email_create(payload) {
  return roughmeadowAPI.post(`/rest-auth/registration/verify-email/`, payload)
}
function rest_auth_user_retrieve(payload) {
  return roughmeadowAPI.get(`/rest-auth/user/`)
}
function rest_auth_user_update(payload) {
  return roughmeadowAPI.put(`/rest-auth/user/`, payload)
}
function rest_auth_user_partial_update(payload) {
  return roughmeadowAPI.patch(`/rest-auth/user/`, payload)
}
